...
--------------------------------------------------------------------------------------------------------------
this base.go handler implements a highly sophisticated and standardized way to define HTTP request handlers
for the Echo web framework. Its core purpose is to wrap business logic with common cross-cutting concerns like
validation, logging, error handling, and performance tracing (observability with New Relic),
eliminating duplication across your application.

It uses Generics to achieve type-safety and flexibility, allowing you to define handlers that automatically manage
their request DTO (Data Transfer Object) and response type.

---------------------------------------------------------------------------------------------------------------

TASK: COME BACK TO THIS FILE AND UNDERSTAND HOW IS IT WORKING WHEN YOU ARE WORKING WITH DTO'S
...
import (
	...
	"github.com/bruhngl0/goBruh/internal/middleware"
	"github.com/bruhngl0/goBruh/internal/server"
	"github.com/bruhngl0/goBruh/internal/validation"
